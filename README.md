...
### Option A: Local preview (recommended)
...
3. Sign in with a Supabase Auth user that has a row in `memberships`.
4. Verify pages:
   - `/dashboard`
   - `/contacts`
   - `/companies`
...
### Option C: Hosted preview deployment

1. Push branch to GitHub.
2. Import project into Vercel.
3. Set environment variables from `.env.example`.
4. Run the SQL migration in Supabase.
5. Open the generated Vercel preview URL.
